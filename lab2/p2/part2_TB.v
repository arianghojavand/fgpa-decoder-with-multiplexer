...
module part2_TB;
	...
	one_bit_4to1mux uut1(.s(select),.u(input1),.v(input2),.w(input3),.x(input4),.m(output1));
	one_bit_4to1muxV2 uut2(.s(select),.u(input1),.v(input2),.w(input3),.x(input4),.m(output2));
	...
	always @(count) begin
		...
		4'b1000 : begin input1 = 1'b0; input2 = 1'b1; input3 = 1'b1; input4 = 1'b1; select = 2'b00; end
		4'b1001 : begin input1 = 1'b1; input2 = 1'b1; input3 = 1'b1; input4 = 1'b0; select = 2'b11; end
